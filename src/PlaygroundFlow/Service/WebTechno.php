...
class WebTechno extends EventProvider implements ServiceManagerAwareInterface
{
    ...
    public function create(array $data)
    {
        ...
        $form  = $this->getServiceManager()->get('playgroundflow_webtechno_form');
        $form->bind($webTechno);
        $form->setData($data);
    ...
    public function getWebTechnoMapper()
    {
        if (null === $this->webTechnoMapper) {
            $this->webTechnoMapper = $this->getServiceManager()->get('playgroundflow_webtechno_mapper');
        }
