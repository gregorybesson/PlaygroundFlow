...
class ObjectAttributeMapping implements ServiceLocatorAwareInterface
{
    /**
    ...
    {
        if (null === $this->er) {
            $this->er = $this->em->getRepository('PlaygroundFlow\Entity\OpenGraphObjectAttributeMapping');
        }
