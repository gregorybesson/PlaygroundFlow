...
namespace PlaygroundFlow\Options;
...
class ModuleOptions
{
     ...
     * @var string
     */
    protected $actionEntityClass = 'PlaygroundFlow\Entity\Action';
     ...
     */
    protected $media_path = 'public/media/story';
    
    /**
     * url path to story media files
     */
    protected $media_url = 'media/story';
    ...
    protected $actionMapper = 'PlaygroundFlow\Mapper\Action';
